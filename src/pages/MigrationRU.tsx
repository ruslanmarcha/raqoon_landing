        ...
        <section className={`section ${styles.content}`}>
          <div className="container">
            <div className={styles.card}>
              ...
              <p className={styles.note}>
                <strong>Если ты уже нажал «Создать аккаунт» раньше времени:</strong> не создавай второй аккаунт и
                не пытайся входить «в другую учётку». Останься в том аккаунте, который уже создал, и просто
                активируй <strong>промокод миграции</strong> в нём.
              </p>
            </div>
